...
public class ForumDiscussionListActivity extends ActivityBase {
	...
	/*
	 * final ForumDiscussion[] discussionList = f.getDiscussionList(); final
	 * ForumDiscussionParcel[] discussionListParcel = new
	 * ForumDiscussionParcel[discussionList.length]; for (int i = 0; i <
	 * discussionList.length; i++) discussionListParcel[i] = new
