...
public class ApplicationPrivateStore {
    ...
    private abstract static class SavedArguments {
        public static final String STORE_NAME = "com.mits.mobile.ourvle.Classes.DataLayer.Android.ApplicationPrivateStore.SotreName";

        public static final String PREFIX = "com.mits.mobile.ourvle.Classes.DataLayer.Android.ApplicationPrivateStore.quick_setting.";
