...
import edu.uwi.mona.mobileourvle.app.Classes.DataLayer.Databases.OpenHelpers.MoodleUserContactOpenHelper.Schema.Column;
...
public class MoodleUserContactOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String[] DATABASE_COLUMNS =
	    new String[] { Schema.Column.USER_ID, Schema.Column.CONTACT_URI };

    private static final String DATABASE_TABLE_CREATE =
	    QB.CREATE_TABLE(Schema.USER_CONTACTS_TABLE,
		    QB.PRIMARY_KEY(
			    QB.INTEGER(Schema.Column.USER_ID)),
		    QB.TEXT(Schema.Column.CONTACT_URI));
